...
class XiguaParserTest(unittest.TestCase):
    ...
    def test_xigua_mobile_ssr_parsing(self, mock_douyin_fetch):
        ...
        sample_article_info = {
            ...
            "mediaUser": {
                "screenName": "西瓜创作者",
                "avatarUrl": "https://sf1.ixiguastatic.com/avatar.jpg"
            },
        ...
        vod_response_data = {
            ...
            "Result": {
                "Data": {
                    "CoverUrl": "https://p3.ixigua.com/test_cover.jpg",
                    "PlayInfoList": [
                        {
                            "Definition": "1080p",
                            "Bitrate": 2000000,
                            "MainPlayUrl": "https://v26.ixiguavod.com/video_1080p.mp4"
                        },
                        {
                            "Definition": "720p",
                            "Bitrate": 1000000,
                            "MainPlayUrl": "https://v26.ixiguavod.com/video_720p.mp4"
                        }
                    ]
                }
            }
        ...
        with patch.object(XiguaParser, "_fetch_xigua_mobile_ssr") as mock_ssr:
            mock_ssr.return_value = {
                "xigua_article_info": sample_article_info,
            ...
            self.assertEqual(parser.get_author_info(), {
                "author": "西瓜创作者",
                "avatar": "https://sf1.ixiguastatic.com/avatar.jpg"
            })
            self.assertEqual(parser.get_real_video_url(), "https://v26.ixiguavod.com/video_1080p.mp4")
            self.assertEqual(parser.get_video_list(), ["https://v26.ixiguavod.com/video_1080p.mp4"])
